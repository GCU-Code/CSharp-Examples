---
title: LAB 4-24: Output Values Below an Amount
subtitle: CST-105
...
# LAB 4-24: Output Values Below an Amount
...
public class LabProgram {
   public static void main(String[] args) {
      ...
      int numTotal = scnr.nextInt();
      while(scnr.hasNextInt()){
         userValues[index] = scnr.nextInt();
         ++index;
      }
      numThreshold = userValues[numTotal];

      for(int i = 0; i < userValues.length; ++i){
         if(i < numTotal && userValues[i] < numThreshold){
